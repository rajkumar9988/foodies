    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-nav2 navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-nav1  navbar-left">
                        ...
                        <li><a href="Contact.jsp?email=${param.email}">CONTACT US</a></li>
                    </ul>
        ...
        <div id="COMBO" class="bg-1">
            ...
            <div class="container">
                    ...
                    <c:forEach items="${catMap.keySet()}" var="x">
                        <h1>${x}</h1>
                        <div class="row text-center">
                        <c:forEach items="${catMap.get(x)}" var="y">
                            <div class="col-sm-4">
                                <div class="thumbnail">
                                    <img src="${y.getImage()}" alt="Paris">
                                    <input type="hidden" value="${y.getId()}" />
                                    <p><strong>${y.getProductname()}</strong></p>
                                    <p>${y.getCategoryname()}</p><br>
                                    <a href="ViewSingleProduct.jsp?id=${y.getId()}" class="btn btn-1">Add To Cart</a>
                                </div>
                            </div>
